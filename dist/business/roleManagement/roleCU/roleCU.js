...
var SpecificModal = function (_Component) {
  (0, _inherits3.default)(SpecificModal, _Component);

  function SpecificModal(props) {
    (0, _classCallCheck3.default)(this, SpecificModal);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SpecificModal.__proto__ || (0, _getPrototypeOf2.default)(SpecificModal)).call(this, props));
  ...
  (0, _createClass3.default)(SpecificModal, [{
    key: "handleSubmit",
      ...
      this.props.form.validateFieldsAndScroll(function (err, fields) {
        if (!err) {
          ...
          if (_this2.state.isEdit) {
            ...
            url = _getConfig2.default.host + "/sys/role/update";
          } else {
            url = _getConfig2.default.host + "/sys/role/save";
          }
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              getFieldDecorator("name", {
                rules: [{
                  required: true, type: "string", message: "请填写角色名称!"
                }, {
            ...
            _react2.default.createElement(
              ...
              })(_react2.default.createElement(_input2.default, { placeholder: "\u8BF7\u586B\u5199\u7F16\u7801", disabled: isEdit }))
            ),
            _react2.default.createElement(
              FormItem,
              (0, _extends3.default)({
...
exports.default = _form2.default.create()(SpecificModal);
...
var _tenantCU = require("./tenantCU/tenantCU");

var _tenantCU2 = _interopRequireDefault(_tenantCU);
...
var options = {
  ...
  del: function del(record, target) {
    _request2.default.POST(_getConfig2.default.host + "/sys/tenant/delete/" + record.id).then(function (res) {
      if (res.success) {
  ...
  disable: function disable(record, target) {
    var url = _getConfig2.default.host + "/sys/tenant/disable";
    if (record.status === "0") {
      url = _getConfig2.default.host + "/sys/tenant/enable";
    }
    if (record.status === "0") {
      record.status = "1";
    } else {
    ...
    target.forceUpdate();
    _request2.default.POST(url, { body: { id: record.id } }).then(function (res) {
      if (res.success) {
        _notification3.default.success({
          message: "操作成功"
        });
  ...
  return [{
    ...
    render: function render(text, record) {
      return _react2.default.createElement(
        "span",
        null,
        _react2.default.createElement(_switch2.default, { checked: record.status === "1", onChange: function onChange() {
            return options.disable(record, target);
          } })
      );
    }
  }, {
...
var TenantManagement = (_temp = _class = function (_Component) {
  (0, _inherits3.default)(TenantManagement, _Component);

  function TenantManagement(props) {
    (0, _classCallCheck3.default)(this, TenantManagement);

    var _this = (0, _possibleConstructorReturn3.default)(this, (TenantManagement.__proto__ || (0, _getPrototypeOf2.default)(TenantManagement)).call(this, props));
  ...
  (0, _createClass3.default)(TenantManagement, [{
    ...
    value: function loadData(params) {
      ...
      _request2.default.POST(_getConfig2.default.host + "/sys/tenant/list", { params: this.state.params }).then(function (res) {
        _this2.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.modalVisiable && _react2.default.createElement(_tenantCU2.default, {
...
exports.default = _form2.default.create()(TenantManagement);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      getFieldDecorator("max", {
        ...
        rules: [{ required: true, message: "最大值必填!" }, { pattern: /^\d*$/, message: "只能是数字!" }]
      })(_react2.default.createElement(_input2.default, null))
    ),
    _react2.default.createElement(
      _form.FormItem,
      ...
      getFieldDecorator("numLength", {
        ...
        rules: [{ required: true, message: "长度必填!" }, { pattern: /^\d*$/, message: "只能是数字!" }]
      })(_react2.default.createElement(_input2.default, null))
    ),
    _react2.default.createElement(
      _form.FormItem,
      ...
      getFieldDecorator("prefix", {
        ...
        rules: [{ required: true, message: "前缀必填!" }]
      })(_react2.default.createElement(_input2.default, null))
    ),
    _react2.default.createElement(
      _form.FormItem,
      ...
      getFieldDecorator("fetchSize", {
        ...
        rules: [{ required: true, message: "批量必填!" }, { pattern: /^\d*$/, message: "只能是数字!" }]
      })(_react2.default.createElement(_input2.default, null))
    ),
    _react2.default.createElement(
      _form.FormItem,
      ...
      getFieldDecorator("step", {
        ...
        rules: [{ required: true, message: "步长必填!" }, { pattern: /^\d*$/, message: "只能是数字!" }]
      })(_react2.default.createElement(_input2.default, null))
    ),
    _react2.default.createElement(
      _form.FormItem,
...
var AutoNumber = (_temp = _class = function (_Component) {
  (0, _inherits3.default)(AutoNumber, _Component);

  function AutoNumber() {
    (0, _classCallCheck3.default)(this, AutoNumber);
    return (0, _possibleConstructorReturn3.default)(this, (AutoNumber.__proto__ || (0, _getPrototypeOf2.default)(AutoNumber)).apply(this, arguments));
  }

  (0, _createClass3.default)(AutoNumber, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_tableClassicCRUD2.default, this.props),
